...
class AddPatient
{
	...
	JTextField txtId, txtName, txtContact, txtNominateNo, txtAge, txtBlood, txtAddress, txtMajorDisease;
	...
	AddPatient()
	{
		...
		lbl = new JLabel("Add Patient");
		lbl.setBounds(270,10,500,60);
		...
		btnSave.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent ae)
				{
					...
					String gender1 = rbMale.getText().toString();
					String gender2 = rbFemale.getText().toString();


					String nationality = (String)cbNationality.getSelectedItem();
					String nominateNo = txtNominateNo.getText().toString();
					String bloodGroup = txtBlood.getText().toString();
					String address = txtAddress.getText().toString();
					String majorDisease = txtMajorDisease.getText().toString();
					
					String gender = gender1+gender2;

					if(rbMale.equals("Male"))
					{
					...
					Object[] newRow = {id,pName,phone,age,gender,nationality,nominateNo,bloodGroup,address,majorDisease};
					new AddDiagnosis().model.addRow(newRow);
					win.setVisible(false);
					...
					txtAge.setText(null);
					txtNominateNo.setText(null);
					txtBlood.setText(null);
					txtAddress.setText(null);
					txtMajorDisease.setText(null);

					/*try{
						FileWriter fw = new FileWriter("E:\\HospitalData\\AddPatient.txt");
						fw.write("\n "+id+"\t"+pName+"\t"+phone+"\t"+age+"\t"+nationality+"\t"+nominateNo+"\t"+bloodGroup+"\t"+address+"\t"+majorDisease);
						fw.close();
